...
#define GNULIB_LOCK IN_VIRT_P2V_GNULIB_TESTS
...
#define GNULIB_STRERROR_R_POSIX IN_VIRT_P2V_GNULIB_TESTS
...
#define PACKAGE_NAME "virt-p2v"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "virt-p2v 1.42.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "virt-p2v"
...
/* Full version string. */
#define PACKAGE_VERSION_FULL "1.42.0"

/* Major version number. */
#define PACKAGE_VERSION_MAJOR 1

/* Minor version number. */
#define PACKAGE_VERSION_MINOR 42
